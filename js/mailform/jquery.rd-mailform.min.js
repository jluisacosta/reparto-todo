...
!function (e) {
    ...
    i = {
        ...
        MF003: "Por favor, define un campo 'e-mail' un el formulario!",
    ...
    t.Defaults = {
        validator: {
            ...
            constraints: {
                ...
                "@NumbersOnly": {rule: "^-?\\d*\\.?\\d*$", message: "Por favor introduce números solamente!"},
                ...
                "@Date": {
                    ...
                    }, message: "Usa el formato MM/DD/YYYY para la fecha!"
                },
                "@SelectRequired": {
                    rule: function (e) {
